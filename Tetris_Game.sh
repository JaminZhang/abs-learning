...
#   Version: 7.1.6 11/01/2011 BeiJing China [Updated 08/19/2015]        #
#                                                                       # 
#   Algorithm:                                                          #
#                                                                       #
#   [][] [][]   [][]            [][]   [][]          [][]   [][] [][]   #
...
show.notify()
{
   ...
   printf "\e[38;5;106;1m\e[$((toph+19));${dist}HTetris Game  Version 7.1.6\n"
   printf "\e[$((toph+20));${dist}HYongYe <complex.invoke@gmail.com>\e[$((toph+21));${dist}H11/01/2011 BeiJing China [Updated 08/19/2015]\n"
}
   ...
   -v|--version) echo "Tetris Game  Version 7.1.6 [Updated 08/19/2015]" ;;
